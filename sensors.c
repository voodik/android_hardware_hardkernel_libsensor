...
{
	mSensors[accelermeter] 		= new OdroidSensor();
	mPollFds[accelermeter].fd 	= mSensors[accelermeter]->getFd();
	mPollFds[accelermeter].events 	= POLLIN;
	mPollFds[accelermeter].revents 	= 0;
